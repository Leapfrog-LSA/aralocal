...
import type { AraLegalDocument, AraLegalWorkflow } from "../shared/types";
import { createTabularReview } from "@/app/lib/araLegalApi";
import { useRouter } from "next/navigation";
import { formatIcon, formatLabel } from "../tabular/columnFormat";
import { useDirectoryData } from "../shared/useDirectoryData";
import { FileDirectory } from "../shared/FileDirectory";
import type { AraLegalProject } from "../shared/types";
import { useChatHistoryContext } from "@/app/contexts/ChatHistoryContext";

interface Props {
    workflows: AraLegalWorkflow[];
    workflow: AraLegalWorkflow | null;
    onClose: () => void;
}
...
// ---------------------------------------------------------------------------
function AssistantPanel({ workflow }: { workflow: AraLegalWorkflow }) {
    return (
...
// ---------------------------------------------------------------------------
function TabularPanel({ workflow }: { workflow: AraLegalWorkflow }) {
...
export function DisplayWorkflowModal({ workflows, workflow, onClose }: Props) {
    ...
    const [selected, setSelected] = useState<AraLegalWorkflow | null>(workflow);
    ...
    async function handleStartChat() {
        ...
        try {
            ...
            if (!chatId) return;
            const allDocs: AraLegalDocument[] = [
                ...standaloneDocuments,
