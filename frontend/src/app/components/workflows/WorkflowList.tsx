...
import type { AraLegalWorkflow } from "../shared/types";
...
export function WorkflowList() {
    ...
    const { user } = useAuth();
    const [custom, setCustom] = useState<AraLegalWorkflow[]>([]);
    const [loading, setLoading] = useState(true);
    const [selected, setSelected] = useState<AraLegalWorkflow | null>(null);
    ...
    const [typeFilter, setTypeFilter] = useState<AraLegalWorkflow["type"] | null>(
        null,
    );
    ...
    const getTypeMeta = (type: AraLegalWorkflow["type"]) =>
        type === "tabular"
