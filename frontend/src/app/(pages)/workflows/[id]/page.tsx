...
import { getWorkflow, updateWorkflow } from "@/app/lib/araLegalApi";
...
import type { ColumnConfig, AraLegalWorkflow } from "@/app/components/shared/types";
import {
    BUILT_IN_IDS,
    BUILT_IN_WORKFLOWS,
...
export default function WorkflowDetailPage({ params }: Props) {
    ...
    const [workflow, setWorkflow] = useState<AraLegalWorkflow | null>(null);
